...
--@localization(locale="itIT", format="lua_additive_table", handle-unlocalized="english", same-key-is-true=true, namespace="Message")@
...
--@localization(locale="itIT", format="lua_additive_table", handle-unlocalized="english", same-key-is-true=true, namespace="Question")@
